      ...
      <div className="container mx-auto flex justify-between items-center">
        ...
        >
          <li className="py-2 md:py-0">
            <Link href="/" className="text-white font-medium hover:text-[#C1DBB3] transition duration-300 block px-4">
              Home
            </Link>
          </li>
          <li className="py-2 md:py-0">
            <Link href="/about" className="text-white font-medium hover:text-[#C1DBB3] transition duration-300 block px-4">
              About
            </Link>
          </li>
          <li className="py-2 md:py-0">
            <Link href="/contact" className="text-white font-medium hover:text-[#C1DBB3] transition duration-300 block px-4">
              Contact
            </Link>
          </li>
        </ul>
